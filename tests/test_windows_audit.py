...
class WinAuditWatcherTests(TempHomeCase):
    ...
    def record(self, record_id, object_name=None, process=r"C:\evil.exe"):
        return {
    ...
    def test_matching_record_becomes_a_read_hit_with_process_info(self):
        ...
        self.assertIn("evil.exe", hits[0].process_info)
...
class SetupGuardTests(TempHomeCase):
    ...
    def test_unelevated_setup_prints_the_elevated_instructions(self):
